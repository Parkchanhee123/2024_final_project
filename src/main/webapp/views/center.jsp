            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">전력 사용량</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">수도 사용량</p>
                                <h5 class="font-weight-bolder">
                                    + 135 리터
                                </h5>
                                <p class="mb-0">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">월세 내는 날</p>
                                <h5 class="font-weight-bolder">
                                    D-23
                                </h5>
                            </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-7 mb-lg-0 mb-4">
            <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    <h6 class="text-capitalize">에너지 사용량</h6>
                ...
                <div class="card-body p-3">
                    <div>
                        <img src="<c:url value="/../img/peongmundo.jpg"/>">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-5">
            <div class="col-lg-12 mb-lg-0 mb-5">
                <div class="card z-index-2 h-100">
                    <div class="chart">
                        <canvas id="chart-line" class="chart-canvas" height="300" style="display: block; box-sizing: border-box; height: 300px; width: 579.3px;" width="579"></canvas>
                    </div>
                    <p>현재 에너지 사용량</p>
                    <div>
                    ...
                    <table class="table align-items-center ">
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <img src="<c:url value="/img/icons/flags/US.png"/>"
                                             alt="Country flag">
                                    </div>
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">Country:</p>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <img src="<c:url value="/img/icons/flags/DE.png"/>"
                                             alt="Country flag">
                                    </div>
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">Country:</p>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <img src="<c:url value="/img/icons/flags/GB.png"/>"
                                             alt="Country flag">
                                    </div>
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">Country:</p>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div>
                                        <img src="<c:url value="/img/icons/flags/BR.png"/>"
                                             alt="Country flag">
                                    </div>
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">Country:</p>
